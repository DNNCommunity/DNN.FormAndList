...
<div class="dnnForm dnnFormAndListConfig" id="dnnFormAndListConfig">
	<ul class="dnnAdminTabNav dnnClear">
		<li><a href="#ssSchemaSettings"><asp:Label resourcekey="FnlSchema" runat="server"  /></a></li>
		<li><a href="#ssPageSettings"> <asp:Label  resourcekey="BehaviorSettings" runat="server"  /></a></li>
	</ul>
	<div id="ssSchemaSettings">
		<h2 class="dnnFormSectionHead"><a href="" ><asp:Label runat="server" ResourceKey="UdtSettings" /></a></h2>
		<fieldset>
			<div runat="server" id="udtSection" style="margin-top: 10px">
                <div><asp:Label runat="server" resourcekey="UdtTeaser" /></div>
...
&nbsp;<div class="dnnFormItem">
	...
	<div id="ssPageSettings" class="ssPageSettings">
	    <h2 class="dnnFormSectionHead"><a href="" ><asp:Label runat="server" ResourceKey="DisplaySettings" /></a></h2>
		<fieldset>
		  <div>
			<div class="dnnFormItem">
        ...
        <h2 class="dnnFormSectionHead"><a href="" ><asp:Label runat="server" ResourceKey="FormSettings" /></a></h2>
	    <fieldset>
	        <div  id="plainFormSettingSet" runat="server">
	            ...
	            <div class="dnnFormItem" id="rowSubmissionText" runat="server">
	                ...
	                <div class="dnnLeft"><dnn:TextEditor ID="teSubmissionSuccess" runat="server" Height="250" Width="400"/></div>
                </div>
            </div>
	        <div runat="server" id="noFormSettings" class="dnnFormItem" >
	            <asp:Label runat="server" resourcekey="noFormSettings" ></asp:Label>
	        </div>
	    </fieldset>


		<h2 class="dnnFormSectionHead"><a href="" ><asp:Label runat="server" ResourceKey="ListSettings" /></a></h2>
		<fieldset >
			<div class="dnnFormItem">
		...
		<h2 class="dnnFormSectionHead"><a href="" ><asp:Label runat="server" ResourceKey="EmailSettings" /></a></h2>
		<fieldset>
            <div class="dnnFormItem">
			    <dnn:Label ID="plTrackingOn" runat="server" Suffix=":" ControlName="txtTrackingTrigger" />
                <table class="dnnLeft dnnFormRadioButtons">
                  <tr>
                    <td><asp:CheckBox ID="chkTrackingOnNew" runat="server" resourcekey="TrackingOnNew" CssClass="Normal" /></td>
                    <td><asp:CheckBox ID="chkTrackingOnUpdate" runat="server" resourcekey="TrackingOnUpdate" CssClass="Normal" /></td>
                    <td><asp:CheckBox ID="chkTrackingOnDelete" runat="server" resourcekey="TrackingOnDelete" CssClass="Normal" /></td>
                  </tr>
                </table>
			</div>
			<div class="dnnFormItem">
			...
			<div class="dnnLeft"><dnn:TextEditor ID="teTrackingMessage" runat="server" Height="250" Width="400"/></div>
			</div>
			<div class="dnnFormItem">
	...
	<ul class="dnnActions dnnClear">
	  <li><dnn:CommandButton ID="cmdUpdate" runat="server" CssClass="dnnPrimaryAction" ResourceKey="cmdSaveAndBack" /></li>
	  <li><dnn:CommandButton ID="cmdCancel" runat="server" CssClass="dnnSecondaryAction" ResourceKey="cmdCancel" /></li>
	</ul>
